...
static void log_func(int priority, const char * format, ... )
{
    ...
    switch (priority) {
    case LOG_DEBUG: printf("%s[Debug]%s %s", CONSOLE_COLOR_BLUE, CONSOLE_COLOR_DEFAULT, logbuff); break;
    case LOG_INFO: printf("%s[Info]%s %s", CONSOLE_COLOR_GREEN, CONSOLE_COLOR_DEFAULT, logbuff); break;
    case LOG_NOTICE: printf("%s[Notice]%s %s", CONSOLE_COLOR_CYAN, CONSOLE_COLOR_DEFAULT, logbuff); break;
    case LOG_WARNING: printf("%s[Warning]%s %s", CONSOLE_COLOR_YELLOW, CONSOLE_COLOR_DEFAULT, logbuff); break;
    case LOG_ERR: printf("%s[Error]%s %s", CONSOLE_COLOR_RED, CONSOLE_COLOR_DEFAULT, logbuff); break;
    case LOG_CRIT: printf("%s[Crit]%s %s", CONSOLE_COLOR_WHITE, CONSOLE_COLOR_DEFAULT, logbuff); break;
    default: break;
    }
}
